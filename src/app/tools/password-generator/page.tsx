  ...
  const generatePwd = (len: number, opts: { uppercase: boolean; lowercase: boolean; numbers: boolean; symbols: boolean }) => {
    const chars = {
  ...
  export default function PasswordGeneratorPage() {
    ...
    // Lazy init
    const [password, setPassword] = useState(() => generatePwd(16, {
      uppercase: true,
      lowercase: true,
      numbers: true,
      symbols: true,
    ...
    const handleGenerate = () => {
      setPassword(generatePwd(length, options));
    };
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="space-y-4">
               ...
               <div className="flex flex-col justify-center gap-4">
                  <Button size="lg" onClick={handleGenerate}>Generate New Password</Button>
